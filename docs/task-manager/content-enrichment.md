...
4. The **Task Details** section is same as the one you saw in [Full Content Enrichment Task](#full-content-enrichment) except for the addition of 2 more fields:
...
5. The **Task Assigning** section is also same as the one you saw in [Full Content Enrichment Task](#full-content-enrichment).
...
:::note
If you are an external vendor, you can accept or reject a CE task. Once you accept a task, the SKUs move to `Content Enrichment WIP` state. However, if you are an internal team member in the organisation, there is no such flexibility. Therefore, the SKUs are by default in `Content Enrichment WIP` state.
:::
